...
2. Render clear concepts using ASCII/Mermaid diagrams and LaTeX formulas.
...
- **Checklist**:
  ...
  - [ ] Present a Mermaid diagram of the workflow/interaction.
...
For detailed templates of ADR documentation, general math equations, and Notion API block formats, see [REFERENCE.md](REFERENCE.md).
For concrete example dialogues and responses across different domains (including Notion exports), see [EXAMPLES.md](EXAMPLES.md).
